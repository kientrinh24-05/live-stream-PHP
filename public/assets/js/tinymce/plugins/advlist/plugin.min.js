...
!function () {
    ...
    var n = tinymce.util.Tools.resolve("tinymce.PluginManager"), g = tinymce.util.Tools.resolve("tinymce.util.Tools"),
        u = i(!1), l = i(!0), s = {
            fold: function (t, e) {
                return t()
            }, isSome: u, isNone: l, getOr: t, getOrThunk: r, getOrDie: function (t) {
                throw new Error(t || "error: getOrDie called on none.")
            }, getOrNull: i(null), getOrUndefined: i(void 0), or: t, orThunk: r, map: e, each: function () {
            }, bind: e, exists: u, forall: l, filter: function () {
                return s
            }, toArray: function () {
                return []
            }, toString: i("none()")
    ...
    function c(t, e, n, r, o, i) {
        ...
        1 < i.length ? (c = r, a = o, d = i, (s = t).ui.registry.addSplitButton(e, {
            ...
            select: function (e) {
                var t, n = (t = s).dom.getParent(t.selection.getNode(), "ol,ul"),
