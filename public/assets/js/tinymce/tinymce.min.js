...
!function () {
    ...
    var m = function (e) {
        ...
        }), K = e("string"), h = e("object"), S = e("array"), l = n(null), v = t("boolean"), b = n(void 0),
    ...
    var pe = function (n) {
            ...
            some: pe, none: c, from: function (e) {
                return null == e ? N : pe(e)
            }
        }, ve = Array.prototype.slice, be = Array.prototype.indexOf, ye = Array.prototype.push,
        Ce = y(Array.from) ? Array.from : function (e) {
            return ve.call(e)
        }, we = Object.keys, xe = Object.hasOwnProperty, Se = function (e, r) {
            var o = {};
            return Q(e, function (e, t) {
                var n = r(e, t);
                o[n.k] = n.v
    ...
    var Ke = function (e, t) {
            ...
            nu: Ke, detect: function (e, t) {
                ...
                }(e, n = o)) ? Ke(i(1), i(2)) : {major: 0, minor: 0};
            ...
            var n
        }, Ge = De(/^\s+|\s+$/g), Je = De(/^\s+/g), Qe = De(/\s+$/g), Ze = /.*?version\/\ ?([0-9]+)\.([0-9]+).*/, et = {
            browsers: J([{
                ...
                name: "Safari", versionRegexes: [Ze, /.*?cpu os ([0-9]+)_([0-9]+).*/], search: function (e) {
        ...
        }, tt = "Firefox", nt = function () {
            return qe({current: void 0, version: Xe.unknown()})
        }, rt = qe, ot = (J("Edge"), J("Chrome"), J("IE"), J("Opera"), J(tt), J("Safari"), "Windows"), it = "Android",
        at = "Solaris", ut = "FreeBSD", st = "ChromeOS", ct = function () {
            return $e({current: void 0, version: Xe.unknown()})
        }, lt = $e, ft = (J(ot), J("iOS"), J(it), J("Linux"), J("OSX"), J(at), J(ut), J(st), Ae(function () {
        ...
        yt = -1 !== dt.indexOf("Windows Phone"), Ct = {
            ...
            trim: Ie, isArray: Ne, is: Me, toArray: function (e) {
                ...
                return n
            }, each: se, map: ce, grep: le, inArray: fe, hasOwn: Ee, extend: function (e) {
            ...
            fromHtml: function (e, t) {
                ...
                return We(n)
            }, fromDom: We, fromPoint: function (e, t, n) {
    ...
    function en(e) {
        var r = void 0 === e ? window : e, t = r.document, o = Gt(Et.fromDom(t)), n = void 0 === r ? window : r;
    ...
    var Nn, kn, _n, An = _t(1), Tn = _t(3), Rn = _t(9), Dn = _t(11), On = function (e) {
            return R(e.dom.childNodes, Et.fromDom)
        }, Bn = y(Element.prototype.attachShadow) && y(Node.prototype.getRootNode), Pn = J(Bn), Ln = Bn ? function (e) {
            ...
            var n = t.ownerDocument, r = Et.fromDom(t), o = Ln(r);
        ...
        }, Hn = tn(1), Vn = rn(["textarea", "input"]), qn = tn(3), $n = tn(8), Wn = tn(9), Kn = tn(11), Xn = rn(["br"]),
        Yn = rn(["img"]), Gn = cn("true"), Jn = cn("false"), Qn = rn(["td", "th"]),
        Zn = rn(["video", "audio", "object", "embed"]), er = function (e, t) {
            return dn(e) ? e.style.getPropertyValue(t) : ""
        }, tr = ft().browser, nr = {}, rr = {exports: nr};
    ...
    var ur = rr.exports.boltExport, sr = function (e) {
        function r(e) {
            o() ? i(e) : t.push(e)
        }

        var n = he.none(), t = [], o = function () {
            return n.isSome()
        }, i = function (t) {
            n.each(function (e) {
                setTimeout(function () {
        ...
        return {
            isValue: x, isError: T, getOr: J(n), getOrThunk: J(n), getOrDie: J(n), or: function (e) {
                return fr(n)
            }, orThunk: function (e) {
                return fr(n)
            }, fold: function (e, t) {
        ...
        return {
            isValue: T, isError: x, getOr: u, getOrThunk: function (e) {
                return e()
            }, getOrDie: function () {
                ...
                return dr(e(n))
            }, each: oe, bind: function (e) {
                return dr(n)
            }, exists: T, forall: x, toOptional: he.none
        }
    }, mr = {
        value: fr, error: dr, fromOption: function (e, t) {
    ...
    function hr(e, t, n) {
        for (var r = e.dom, o = y(n) ? n : T; r.parentNode;) {
            var r = r.parentNode, i = Et.fromDom(r);
    ...
    var wr, xr, Sr, Er, Nr, kr = function (e, t) {
        ...
        return t && "object" == typeof t && t.constructor === Ar ? t : new Ar(function (e) {
            e(t)
        })
    ...
    function Mr(m, g) {
        function n(e, t, n) {
            var r, o = St._addCacheSuffix(e), i = ae(h, o).getOrThunk(function () {
        ...
        void 0 === g && (g = {});
        var p = 0, h = {}, v = Et.fromDom(m), b = Tt(v), y = g.maxLoadTime || 5e3;
        return {
    ...
    var Fr, Ur = {
        requestAnimationFrame: function (e, t) {
        ...
        }, setTimeout: Pr, setInterval: Lr, setEditorTimeout: function (e, t, n) {
            return Pr(function () {
                e.removed || t()
            }, n)
            ...
            return r
        }, debounce: Ir, throttle: Ir, clearInterval: function (e) {
    ...
    function mo(e, n) {
        var r;
        return e && (r = {}, di(e = "string" == typeof e ? {"*": e} : e, function (e, t) {
    ...
    function go(i) {
        ...
        var h = mo(i.valid_styles), v = mo(i.invalid_styles, "map"), b = mo(i.valid_classes, "map"),
            ...
            N = "td th iframe video audio object script code", k = e("non_empty_elements", N + " pre", w),
        ...
        function O(e) {
            ...
            if (e) {
                var x = fo(e, ",");
                for (S["@"] && (h = S["@"].attributes, v = S["@"].attributesOrder), t = 0, n = x.length; t < n; t++) if (i = y.exec(x[t])) {
                    if (g = i[1], c = i[2], p = i[3], s = i[5], a = {
                        attributes: d = {},
                        attributesOrder: m = []
                    }, "#" === g && (a.paddEmpty = !0), "-" === g && (a.removeEmpty = !0), "!" === i[4] && (a.removeEmptyAttrs = !0), h && (Q(h, function (e, t) {
                        d[t] = e
                    }), m.push.apply(m, v)), s) for (r = 0, o = (s = fo(s, "|")).length; r < o; r++) (i = C.exec(s[r])) && (u = {}, f = i[1], l = i[2].replace(/[\\:]:/g, ":"), g = i[3], b = i[4], "!" === f && (a.attributesRequired = a.attributesRequired || [], a.attributesRequired.push(l), u.required = !0), "-" !== f ? (g && ("=" === g && (a.attributesDefault = a.attributesDefault || [], a.attributesDefault.push({
                        name: l,
                        value: b
        ...
        function L(e) {
            ...
            ci[i.schema] = null, e && di(fo(e, ","), function (e) {
                var t, n, r = o.exec(e);
                r && (n = r[1], t = n ? l[r[2]] : l[r[2]] = {"#comment": {}}, t = l[r[2]], di(fo(r[3], "|"), function (e) {
                    "-" === n ? delete t[e] : t[e] = {}
                }))
            })
        }
        ...
        var M = J(h), F = J(v), U = J(b), z = J(x), j = J(T), H = J(A), V = J(R), q = J(w), $ = J(C), W = J(k),
        ...
        return {
            toHex: function (e) {
                ...
                if (e) {
                    ...
                    }); s = x.exec(e);) x.lastIndex = s.index + s[0].length, c = s[1].replace(S, "").toLowerCase(), l = s[2].replace(S, ""), c && l && (c = i(c), l = i(l), -1 === c.indexOf(N) && -1 === c.indexOf('"') && (b.allow_script_urls || "behavior" !== c && !/expression\s*\(|\/\*|\*\//.test(l)) && ("font-weight" === c && "700" === l ? l = "bold" : "color" !== c && "background-color" !== c || (l = l.toLowerCase()), l = (l = l.replace(C, po)).replace(w, a), p[c] = f ? u(l, !0) : l));
    ...
    function wo(e, t) {
        var n, r, o, i, a = bo(e.type, e, document, t);
    ...
    var xo = Vr(["h1", "h2", "h3", "h4", "h5", "h6"]),
        ...
        No = Vr(["ul", "ol", "dl"]), ko = Vr(["li", "dd", "dt"]), _o = Vr(["thead", "tbody", "tfoot"]),
        Ao = Vr(["td", "th"]), To = Vr(["pre", "script", "textarea", "style"]), Ro = "\ufeff", Do = "\xa0", Oo = Ro,
        Bo = function (e) {
            return e === Ro
        }, Po = function (e) {
            return e.replace(/\uFEFF/g, "")
        }, Lo = Hn, Io = qn, Mo = function (e) {
            return Io(e) && e.data[0] === Oo
        }, Fo = function (e) {
            return Io(e) && e.data[e.data.length - 1] === Oo
        }, Uo = Gn, zo = Jn, jo = Xn, Ho = qn, Vo = rn(["script", "style", "textarea"]),
        qo = rn(["img", "input", "textarea", "hr", "iframe", "video", "audio", "object", "embed"]), $o = rn(["table"]),
        Wo = Xr, Ko = function (e) {
            return !1 === (Hn(t = e) && "true" === t.getAttribute("unselectable")) && zo(e);
            var t
        }, Xo = /^[ \t\r\n]*$/, Yo = an("data-mce-bookmark"), Go = an("data-mce-bogus"), Jo = function (e) {
        ...
        si = {
            encodeRaw: so, encodeAllRaw: function (e) {
                return ("" + e).replace(ni, function (e) {
                    return ii[e] || e
                })
            }, encodeNumeric: co, encodeNamed: lo, getEncodeFunc: function (e, t) {
                var n = uo(t) || ui, r = Zo(e.replace(/\+/g, ","));
        ...
        }, ci = {}, li = {}, fi = St.makeMap, di = St.each, mi = St.extend, gi = St.explode, pi = St.inArray, hi = {
            keyLocation: !0,
            layerX: !0,
            layerY: !0,
            returnValue: !0,
            ...
            keyIdentifier: !0,
            mozPressure: !0
        }, vi = /^(?:mouse|contextmenu)|click/, bi = (yi.prototype.bind = function (e, t, n, r) {
            function o(e) {
            ...
            if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
                ...
                for (var m = t.split(" "), g = m.length; g--;) c = o, s = l = !1, "DOMContentLoaded" === (u = m[g]) && (u = "ready"), f.domLoaded && "ready" === u && "complete" === e.readyState ? n.call(r, wo({type: u})) : (f.hasMouseEnterLeave || (s = f.mouseEnterLeave[u]) && (c = function (e) {
                ...
                }), (a = f.events[i][u]) ? "ready" === u && f.domLoaded ? n(wo({type: u})) : a.push({
                    func: n,
                    scope: r
                }) : (f.events[i][u] = a = [{
                    func: n,
                    ...
                    }, "complete" === o.readyState || "interactive" === o.readyState && o.body ? r() : yo(e, "DOMContentLoaded", r), n.domLoaded || yo(e, "load", r))
                }(e, c, f) : yo(e, s || u, c, l)));
                return e = a = null, n
            }
    ...
    var wi, xi, Si, Ei, Ni, ki, _i, Ai, Ti, Ri, Di, Oi, Bi, Pi, Li, Ii, Mi, Fi = "sizzle" + -new Date,
        Ui = window.document, zi = 0, ji = 0, Hi = ya(), Vi = ya(), qi = ya(), $i = function (e, t) {
            return e === t && (Ri = !0), 0
        }, Wi = "undefined", Ki = {}.hasOwnProperty, Xi = [], Yi = Xi.pop, Gi = Xi.push, Ji = Xi.push, Qi = Xi.slice,
        ...
        ia = new RegExp("^" + ea + "*," + ea + "*"), aa = new RegExp("^" + ea + "*([>+~]|" + ea + ")" + ea + "*"),
        ua = new RegExp("=" + ea + "*([^\\]'\"]*?)" + ea + "*\\]", "g"), sa = new RegExp(ra),
        ca = new RegExp("^" + ta + "$"), la = {
            ID: new RegExp("^#(" + ta + ")"),
            CLASS: new RegExp("^\\.(" + ta + ")"),
            TAG: new RegExp("^(" + ta + "|[*])"),
        ...
        }, fa = /^(?:input|select|textarea|button)$/i, da = /^h\d$/i, ma = /^[^{]+\{\s*\[native \w/,
        ga = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, pa = /[+~]/, ha = /'|\\/g,
    ...
    function ka(a, e, t) {
        var u = e.dir, s = t && "parentNode" === u, c = ji++;
    ...
    function Da(e, t) {
        var n, r = (t = t || Fa).createElement("div"), o = t.createDocumentFragment();
    ...
    wi = ba.support = {}, Ei = ba.isXML = function (e) {
        ...
        var t, s = e ? e.ownerDocument || e : Ui, n = s.defaultView;
        ...
        filter: {
            TAG: function (e) {
                ...
                return 1 === g && 0 === p ? function (e) {
                    ...
                    if (l) {
                        ...
                        if (s = [v ? l.firstChild : l.lastChild], v && d) {
                            for (u = (r = (o = l[Fi] || (l[Fi] = {}))[m] || [])[0] === zi && r[1], a = r[0] === zi && r[2], i = u && l.childNodes[u]; i = ++u && i && i[c] || (a = u = 0) || s.pop();) if (1 === i.nodeType && ++a && i === e) {
                                o[m] = [zi, u, a];
                                break
                            }
                ...
                var t, a = xi.pseudos[e] || xi.setFilters[e.toLowerCase()] || ba.error("unsupported pseudo: " + e);
        ...
        var n, r, o, i, a, u, s, c = Vi[e + " "];
        if (c) return t ? 0 : c.slice(0);
        for (a = e, u = [], s = xi.preFilter; a;) {
            for (i in n && !(r = ia.exec(a)) || (r && (a = a.slice(r[0].length) || a), u.push(o = [])), n = !1, (r = aa.exec(a)) && (n = r.shift(), o.push({
                value: n,
                type: r[0].replace(oa, " ")
            }), a = a.slice(n.length)), xi.filter) xi.filter.hasOwnProperty(i) && (!(r = la[i].exec(a)) || s[i] && !(r = s[i](r)) || (n = r.shift(), o.push({
                value: n,
                type: i,
                matches: r
            }), a = a.slice(n.length)));
        ...
        if (!i) {
            for (n = (t = t || Ni(e)).length; n--;) ((i = function e(t) {
                for (var o, n, r, i = t.length, a = xi.relative[t[0].type], u = a || xi.relative[" "], s = a ? 1 : 0, c = ka(function (e) {
                    ...
                    return o = null, r
                }]; s < i; s++) if (n = xi.relative[t[s].type]) f = [ka(_a(f), n)]; else {
                        ...
                        return function e(m, g, p, h, v, t) {
                            return h && !h[Fi] && (h = e(h)), v && !v[Fi] && (v = e(v, t)), Ca(function (e, t, n, r) {
                                var o, i, a, u = [], s = [], c = t.length, l = e || function (e, t, n) {
                                        ...
                                        return n
                                    }(g || "*", n.nodeType ? [n] : n, []), f = !m || !e && g ? l : Aa(l, u, m, n, r),
                                    d = p ? v || (e ? m : c || h) ? [] : t : f;
        ...
        function a(e, t, n, r, o) {
            var i, a, u, s = 0, c = "0", l = e && [], f = [], d = Ai, m = e || y && xi.find.TAG("*", o),
                g = zi += null == d ? 1 : Math.random() || .1, p = m.length;
        ...
        var o, i, a, u, s, c = "function" == typeof e && e, l = !r && Ni(e = c.selector || e);
        if (n = n || [], 1 === l.length) {
            ...
            for (o = la.needsContext.test(e) ? 0 : i.length; o-- && (a = i[o], !xi.relative[u = a.type]);) if ((s = xi.find[u]) && (r = s(a.matches[0].replace(va, Ci), pa.test(i[0].type) && Sa(t.parentNode) || t))) {
    ...
    var Fa = document, Ua = Array.prototype.push, za = Array.prototype.slice,
        ja = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, Ha = bi.Event, Va = St.makeMap("children,contents,next,prev"),
        qa = function (e, t, n, r) {
            var o;
            if (Ra(t)) t = Da(t, Qa(e[0])); else if (t.length && !t.nodeType) {
                if (t = ou.makeArray(t), r) for (o = t.length - 1; 0 <= o; o--) qa(e, t[o], n, r); else for (o = 0; o < t.length; o++) qa(e, t[o], n, r);
                return e
            }
        ...
        Ka = {for: "htmlFor", class: "className", readonly: "readOnly"}, Xa = {float: "cssFloat"}, Ya = {}, Ga = {},
        Ja = /^\s*|\s*$/g, Qa = function (e) {
    ...
    function eu(e, t, n, r) {
        var o = [];
        for (r instanceof ou && (r = r[0]); e; e = e[t]) if (!n || e.nodeType === n) {
            if (void 0 !== r) {
                if (e === r) break;
    ...
    Pa.fn = Pa.prototype = {
        constructor: Pa, selector: "", context: null, length: 0, init: function (e, t) {
            var n, r, o = this;
            if (!e) return o;
            ...
            if (Ra(e)) {
                ...
                if (n[1]) for (r = Da(e, Qa(t)).firstChild; r;) Ua.call(o, r), r = r.nextSibling; else {
            ...
            if (!1 !== t) for (n = ou.unique(this.toArray().concat(ou.makeArray(e))), this.length = n.length, r = 0; r < n.length; r++) this[r] = n[r]; else Ua.apply(this, ou.makeArray(e));
            return this
        }, attr: function (t, n) {
            var e, r = this;
            if ("object" == typeof t) Ia(t, function (e, t) {
                r.attr(e, t)
            }); else {
                if (!Ta(n)) {
            ...
            var n = this;
            if ("object" == typeof (e = Ka[e] || e)) Ia(e, function (e, t) {
                n.prop(e, t)
            }); else {
        ...
        }, push: Ua, sort: Array.prototype.sort, splice: Array.prototype.splice
    }, St.extend(Pa, {
        extend: St.extend,
    ...
    var ou = Pa, iu = St.each, au = St.grep, uu = Ct.ie, su = /^([a-z0-9],?)+$/i, cu = function (a, u) {
        function s(e) {
        ...
        void 0 === u && (u = {});
        var _, A, T, R, e, t, D = {}, O = window, B = {}, P = 0,
            ...
            U = u.ownEvents ? new bi : bi.Event, z = M.getBlockElements(), j = ou.overrideDefaults(function () {
                return {context: a, element: $.getRoot()}
            }), H = si.encodeAllRaw, V = function (e, t, n, r) {
                if (St.isArray(e)) {
                ...
                isEmpty: function (e, t) {
                    ...
                    if (E(e)) return !1;
                    if (e = e.firstChild) {
                        var i = new jr(e, e.parentNode), a = M ? M.getWhiteSpaceElements() : {};
    ...
    var lu = cu.DOM, fu = St.each, du = St.grep, mu = (gu.prototype._setReferrerPolicy = function (e) {
        ...
        var o = lu, i = o.uniqueId(), a = document.createElement("script");
    ...
    var vu = {}, bu = pu("en"), yu = {
        getData: function () {
            ...
            var o, i, a = hu().getOr({}), u = function (e) {
                return "" === e || null == e
            };
            if (u(e)) return "";
    ...
    function Tu(r, e) {
        ...
        var n = r.selection.getRng(), o = Et.fromDom(n.startContainer), i = Et.fromDom(r.getBody()),
            a = e.fold(function () {
                return "." + es()
            }, function (e) {
                return "[" + ts() + '="' + e + '"]'
    ...
    function Ru(r) {
        ...
        function i(e, t) {
            var n = a.get(), r = t(ae(n, e).getOrThunk(o));
            n[e] = r, a.set(n)
        }

        var a = pu({}), e = Su(function () {
            var e, t, n = a.get();
    ...
    function Ou(e, t) {
        var n, r, o = At(e).dom, i = Et.fromDom(o.createDocumentFragment());
    ...
    var Zu = function (e, t) {
        ...
        }, es = J("mce-annotation"), ts = J("data-mce-annotation"), ns = J("data-mce-annotation-uid"),
        rs = function (e, t) {
        ...
        us = Hn, ss = eo, cs = on("display", "block table"), ls = on("float", "left right"), fs = function () {
            for (var n = [], e = 0; e < arguments.length; e++) n[e] = arguments[e];
            return function (e) {
                for (var t = 0; t < n.length; t++) if (!n[t](e)) return !1;
                return !0
            }
        }(us, ss, s(ls)), ds = s(on("white-space", "pre pre-line pre-wrap")), ms = qn, gs = Xn, ps = cu.nodeIndex,
        hs = function (e, t) {
            if (!(t < 0 && Hn(e) && e.hasChildNodes())) return $u(e, t)
        }, vs = function (e) {
            var t = e.getClientRects(), n = 0 < t.length ? Fu(t[0]) : Fu(e.getBoundingClientRect());
            return !Yu(e) && gs(e) && Ju(n) ? function (e) {
                var t = e.ownerDocument, n = Ku(t), r = t.createTextNode(Do), o = e.parentNode;
    ...
    function Es(e, t) {
        if (!t) return null;
        var n = t.split(","), r = n[0].split("/"), o = 1 < n.length ? n[1] : "before", i = de(r, function (e, t) {
    ...
    function Qs(e, t) {
        var n, r = t.container(), o = (-1 === (n = _(Ce(r.childNodes), e)) ? he.none() : he.some(n)).map(function (e) {
    ...
    function tc(e, i, a, u) {
        ...
        var c, l, f = wu(), t = Ls(e), d = 0 < t.length ? t : "p";
        return {
            show: function (e, t) {
                var n;
                if (s(), Bc(t)) return null;
                if (!a(t)) return l = function (e, t) {
                    var n = e.ownerDocument.createTextNode(Oo), r = e.parentNode;
                    if (t) {
    ...
    function fc(e, t, n) {
        var r, o = A(lc, !0, t), i = A(lc, !1, t), a = n.startContainer, u = n.startOffset;
        if (Wr(a)) {
    ...
    var vc, bc, yc = qn, Cc = un, wc = cu.nodeIndex, xc = function (e) {
            var t = e.parentNode;
            return Cc(t) ? xc(t) : t
        }, Sc = function (e) {
        ...
        }, Ec = Jn, Nc = A(Rs, u, !0), kc = cu.DOM, _c = Hn, Ac = qn, Tc = function (e) {
            _c(e) && Xr(e) && (Yr(e) ? e.removeAttribute("data-mce-caret") : Xs(e)), Ac(e) && (Gs(e), 0 === e.data.length && Xs(e))
        }, Rc = ft().browser, Dc = Jn, Oc = Zn, Bc = Qn, Pc = function (e) {
            return Dc(e) || Oc(e)
        }, Lc = Jn, Ic = Zn, Mc = on("display", "block table table-cell table-caption list-item"), Fc = Xr, Uc = Wr,
        zc = Hn, jc = eo, Hc = A(cc, !0), Vc = A(cc, !1);
    ...
    function Rl(i, e, t, n, a, r) {
        function o(e, t, n) {
            var r = Mu(i), o = a ? r.backwards : r.forwards;
    ...
    function Dl(e, t, n, r, o) {
        ...
        for (var i = Cf(e, r), a = 0; a < i.length; a++) for (var u = 0; u < t.length; u++) {
            var s = t[u];
    ...
    function Il(n, e, u) {
        ...
        var o = e.startOffset, i = $u(e.startContainer, o), a = e.endOffset, l = $u(e.endContainer, a - 1);
        if (i === l) return u(s([i]));
    ...
    function jl(o, e) {
        return fn((r = e.startContainer, i = e.startOffset, qn(r) ? 0 === i ? he.some(Et.fromDom(r)) : he.none() : he.from(r.childNodes[i]).map(Et.fromDom)), (t = e.endContainer, n = e.endOffset, qn(t) ? n === t.data.length ? he.some(Et.fromDom(t)) : he.none() : he.from(t.childNodes[n - 1]).map(Et.fromDom)), function (e, t) {
            var n = I(Ef(o), A(je, e)), r = I(Nf(o), A(je, t));
    ...
    function Hl(e, t, n, r) {
        var o = n, i = new jr(n, o), a = ne(e.schema.getMoveCaretBeforeOnEnterElements(), function (e, t) {
    ...
    function Kl(e, t, n, r) {
        var o = t.uid, i = void 0 === o ? Du("mce-annotation") : o, a = function (e, t) {
            var n = {};
    ...
    function Xl(u, e, t, n, r) {
        ...
        var l = [], f = Kl(u.getDoc(), r, t, n), d = wu(), o = function (e) {
            var t, n, r, o, i, a;
            ...
            register: function (e, t) {
                ...
                i.lookup(t).each(function (e) {
                    ...
                    s = t, c = e, l = n, (u = o).undoManager.transact(function () {
                        var e, t, n, r, o = u.selection, i = o.getRng(), a = 0 < Ul(u).length;
                        i.collapsed && !a && (n = Ll(e = u, t = i, [{inline: "span"}]), t.setStart(n.startContainer, n.startOffset), t.setEnd(n.endContainer, n.endOffset), e.selection.setRng(t)), o.getRng().collapsed && !a ? (Ou(r = Kl(u.getDoc(), l, s, c.decorate), Do), o.getRng().insertNode(r.dom), o.select(r.dom)) : $l(o, !1, function () {
                            ql(u, function (e) {
    ...
    var Ql, Zl, ef, tf = Jn, nf = qn, rf = Hn, of = Xn, af = eo, uf = to, sf = function (e, t, n) {
        var r, o, i;
        ...
        var f = ic(r, e, uf, n), d = ge(U(function (e, t) {
    ...
    function Of(r, l) {
        ...
        function g(e) {
            var t, n, r, o, i, a, u = e.screenX - C, s = e.screenY - w;
        ...
        var p, h, v, b, y, C, w, x, S, E, N, k, _, A, T, R = "data-mce-selected", D = l.dom, O = St.each,
            ...
            F = {nw: [0, 0, -1, -1], ne: [1, 0, 1, -1], se: [1, 1, 1, 1], sw: [0, 1, -1, 1]}, U = function () {
                ...
                H();
                var t = D.getPos(e, M), a = t.x, u = t.y, n = e.getBoundingClientRect(), s = n.width || n.right - n.left,
                    c = n.height || n.bottom - n.top;
                p !== e && (j(), p = e, k = _ = 0);
                var r = l.fire("ObjectSelected", {target: e}), o = D.getAttrib(p, R, "1");
                i(e) && !r.isDefaultPrevented() ? O(F, function (o, i) {
                    ...
                    e && D.remove(e), e = D.add(M, "div", {
                        ...
                        e.stopImmediatePropagation(), e.preventDefault(), t = e, r = d(p)[0], C = t.screenX, w = t.screenY, x = r.clientWidth, S = r.clientHeight, E = S / x, (b = o).name = i, b.startPos = {
                            x: s * o[0] + a,
                            y: c * o[1] + u
                        }, A = M.scrollWidth, T = M.scrollHeight, y = D.add(M, "div", {class: "mce-resize-backdrop"}), D.setStyles(y, {
                            position: "fixed",
                            left: "0",
                            top: "0",
                            width: "100%",
                            height: "100%"
                        }), h = f(n = p) ? D.create("img", {src: Ct.transparentSrc}) : n.cloneNode(!0), D.addClass(h, "mce-clonedresizable"), D.setAttrib(h, "data-mce-bogus", "all"), h.contentEditable = "false", D.setStyles(h, {
                            left: a,
                            top: u,
                            margin: 0
    ...
    function zf(e, t, n, r) {
        var o, i = e.getRoot(), a = !1, u = r[(n ? "start" : "end") + "Container"],
            s = r[(n ? "start" : "end") + "Offset"], c = Hn(u) && s === u.childNodes.length,
    ...
    function jf(e, t) {
        var n = t.collapsed, r = t.cloneRange(), o = bs.fromRangeStart(t);
    ...
    var Kf, Xf, Yf = (Kf = "height", Xf = function (e) {
        var t = e.dom;
        ...
        }, get: Gf, getOuter: Gf, aggregate: Jf, max: function (e, t, n) {
            var r = Jf(e, n);
            return r < t ? t - r : 0
        }
    });
    ...
    function Jf(o, e) {
        return P(e, function (e, t) {
            var n = Cn(o, t), r = void 0 === n ? 0 : parseInt(n, 10);
    ...
    function Zf(e, t) {
        var n = function (e) {
            ...
            var i = Yt(null == r ? void 0 : r.pageYOffset, o.scrollTop),
                a = Yt(null == r ? void 0 : r.pageXOffset, o.scrollLeft), u = Yt(o.clientTop, n.clientTop),
    ...
    function ad(e, t, n, r) {
        ...
        var o, i, a, u, s, c, l,
            ...
            }, {left: 0, top: 0}), zn(l.left + c.left + u.left, l.top + c.top + u.top)), d = en(window);
    ...
    var Md, Fd = function (r, e) {
            ...
            var o = Et.fromDom(e.getBody()), i = Et.fromDom(e.getDoc());
            o.dom.offsetWidth;
            var a, u, s, c, l = (a = Et.fromDom(n.startContainer), u = n.startOffset, s = function (e, t) {
                ...
                var r = n[n.length - 1];
                return Qf(r) ? {element: e, offset: t} : "img" === Nt(r) ? {element: r, offset: 1} : Tn(r) ? {
                    element: r,
                    offset: Wl(r).length
        ...
        $d = {
            domRange: qd.domRange, relative: qd.relative, exact: qd.exact, exactFromRange: function (e) {
    ...
    function tm(W, K) {
        var e;
        void 0 === K && (K = go());
        var X = null !== (e = (W = W || {}).document) && void 0 !== e ? e : document, Y = X.createElement("form");
                ...
                if (x < t.index && R(N(w.substr(x, t.index - x))), i = t[7]) T(i = ":" === (i = i.toLowerCase()).charAt(0) ? i.substr(1) : i); else if (i = t[8]) {
                    ...
                    if (!U || (s = K.getElementRule(i))) {
                        if (c = !0, U && (h = s.attributes, v = s.attributePatterns), (f = t[9]) ? ((p = -1 !== f.indexOf("data-mce-type")) && z && (c = !1), (g = []).map = {}, f.replace(L, function (e, t, n, r, o) {
                            ...
                            if (d = s.attributesRequired, b = s.attributesDefault, y = s.attributesForced, s.removeEmptyAttrs && !g.length && (c = !1), y) for (r = y.length; r--;) a = (l = y[r]).name, "{$uid}" === (C = l.value) && (C = "mce_" + E++), g.map[a] = C, g.push({
                                name: a,
                                value: C
                            });
                            if (b) for (r = b.length; r--;) (a = (l = b[r]).name) in g.map || ("{$uid}" === (C = l.value) && (C = "mce_" + E++), g.map[a] = C, g.push({
                                name: a,
                                value: C
                            }));
                            if (d) {
        ...
        var G = W.comment || oe, J = W.cdata || oe, Q = W.text || oe, Z = W.start || oe, ee = W.end || oe,
            te = W.pi || oe, ne = W.doctype || oe;
        return {
            parse: function (e, t) {
    ...
    function im(e, t) {
        for (var n, r, o, i, a = /<(\w+) [^>]*data-mce-bogus="all"[^>]*>/g, u = e.schema, s = (n = e.getTempAttrs(), r = t, o = new RegExp(["\\s?(" + n.join("|") + ')="[^"]+"'].join("|"), "gi"), r.replace(o, "")), c = u.getShortEndedElements(); i = a.exec(s);) {
            var l = a.lastIndex, f = i[0].length, d = c[i[1]] ? l : tm.findEndTag(u, s, l),
    ...
    function um(e) {
        var u = [], s = (e = e || {}).indent, c = fm(e.indent_before || ""), l = fm(e.indent_after || ""),
            f = si.getEncodeFunc(e.entity_encoding || "raw", e.entities), d = "html" === e.element_format;
        return {
    ...
    tm.findEndTag = em;
    var cm = im, lm = St.each, fm = St.makeMap, dm = new Set;
    ...
    function wm(e, t) {
        return o = T, He(r = t, n = e) ? function (e, t) {
            for (var n = y(t) ? t : T, r = e.dom, o = []; null !== r.parentNode && void 0 !== r.parentNode;) {
                var i = r.parentNode, a = Et.fromDom(i);
    ...
    function jm(g, e) {
        return he.some(e).filter(zm).bind(function (e) {
            var t, n, r, o, i, a, u, s, c, l = e.container(), f = g, d = (i = l).data, m = bs(i, 0);
    ...
    function $m(e, t) {
        var n = e.data.slice(0, t), r = n.length - Qe(n).length;
        Vm(e, t - r, r)
    }
    ...
    function sg(e, t, n, r) {
        ...
        var i, a, u = og(n.startContainer, r), s = og(n.endContainer, r), c = u.bind((a = r, function (t) {
            return zl(t, a).bind(function (e) {
                return Y(ng(e)).map(function (e) {
                    return rg(t, e)
                })
            })
        })).bind(ug(r)), l = s.bind((i = r, function (t) {
    ...
    function dg(e, t) {
        ...
        return h = t, v = b, y.exists(function (e) {
            ...
            var t = e.start, n = e.end, r = t.bind(lg).getOr([]), o = n.bind(lg).getOr([]);
            ...
            var t = i.isSameTable, n = lg(e).getOr([]);
    ...
    function vg(e, t, n) {
        t.deleteContents();
        var r, o = pp(n).getOr(n), i = Et.fromDom(e.dom.getParent(o.dom, e.dom.isBlock));
    ...
    function xg(e, t) {
        var n, r, o, i, a, u, s, c, l = Et.fromDom(e.selection.getStart(!0)), f = Ul(e);
    ...
    function _g(e, t) {
        var n = bs.after(e), r = Wc(t).prev(n);
        return r ? r.toRange() : null
    }

    function Ag(e, o, i, t) {
        function n(e) {
            var t = bs.fromRangeStart(i), n = Wc(o.getRoot()), r = 1 === e ? n.prev(t) : n.next(t);
            return !r || kg(o, r.getNode()) !== T
        }

        var r, a, u, s, c, l, f, d, m, g, p, h, v, b, y, C, w, x, S, E, N, k, _,
            ...
            T = kg(o, i.startContainer), R = Ng(U(A.firstChild.childNodes, function (e) {
    ...
    function Tg(e, t, n) {
        ...
        var c = e.parser, l = n.merge, f = sm({validate: e.getParam("validate")}, e.schema),
    ...
    function Dg(e, t, n) {
        ...
        e.dom.setHTML(e.getBody(), t), !0 !== n && Td(r = e) && mf(r.getBody()).each(function (e) {
            var t = e.getNode(), n = sn(t) ? mf(t).getOr(e) : e;
        ...
        return n.orThunk(function () {
            return a(i) ? he.none() : function (e) {
                for (var t = i.dom, n = Bg(a); t.parentNode;) {
                    var t = t.parentNode, r = Et.fromDom(t), o = e(r);
    ...
    function Fg(e, t, n, r, o, i) {
        ...
        if (a) if (b(a.length)) {
            for (var u in a) if (Ee(a, u)) {
                var s = "attributes" === r ? e.getAttrib(t, u) : bl(e, t, u), c = pl(a[u], i), l = re(s) || Be(s);
                if (!l || !re(c)) {
    ...
    function qg(e, t, n) {
        ...
        if (t) Vg(e, t, n); else if (!(t = Zc(e.getBody(), o.getStart()))) for (; t = r.get(Sp);) Vg(e, t, !1)
    }
    ...
    function Xg(e, t, n, r) {
        var o, i, a, u, s, c, l, f, d, m, g, p, h, v, b, y = e.dom, C = e.selection, w = [], x = C.getRng(),
            S = x.startContainer, E = x.startOffset, N = S;
    ...
    var Gg, Jg = ["font", "text-decoration", "text-emphasis"], Qg = A(gm, !0, sl), Zg = A(gm, !1, sl), ep = hm(!0, vm),
        tp = hm(!1, vm), np = hm(!0, Zn), rp = hm(!1, Zn), op = hm(!0, sn), ip = hm(!1, sn), ap = hm(!0, bm),
        up = hm(!1, bm), sp = A(km, !1), cp = A(km, !0), lp = A(Nm, !1), fp = A(Nm, !0), dp = A(Am, !1), mp = A(Am, !0),
        ...
        }, xp = Oo, Sp = "_mce_caret", Ep = {}, Np = le, kp = se;
    ...
    function Mp(e, t, n, r, o) {
        var i = Et.fromDom(t), a = Et.fromDom(e.create(r, o));
            ...
            if (g.split) {
                if (t = Vf(t), (r = Pp(u, t, !0)) !== (o = Pp(u, t))) {
                    ...
                    var r = Ip(h, r, "span", {id: "_start", "data-mce-type": "bookmark"}),
                        o = Ip(h, o, "span", {id: "_end", "data-mce-type": "bookmark"}), i = h.createRng();
    ...
    function Wp(e, o, i, a, t, n) {
        ...
        return null === o.get() && (u = e, (r = o).set({}), u.on("NodeChange", function (e) {
            ...
            var n, r = ae(g, t).getOrThunk(function () {
                var e = {
    ...
    function Qp(e, t) {
        for (var n = e.rows, r = 0; r < n.length; r++) for (var o = n[r].cells, i = 0; i < o.length; i++) if (je(o[i], t)) return he.some({
            x: i,
            y: r
        });
        return he.none()
    ...
    function th(e, t) {
        var n, r, o, i = Et.fromDom(t.commonAncestorContainer), a = xm(i, e), u = U(a, function (e) {
            return qr(e) || xo(e)
    ...
    function rh(e, i) {
        return br(i[0], "table", A(je, e)).bind(function (e) {
            var s, t, n = i[0], r = i[i.length - 1], o = eh(e);
    ...
    function ch(n) {
        var e, t = z((e = n.getBody(), U(R(Ce(e.childNodes), uh), function (e) {
            return 0 < e.length
        })), function (e) {
            ...
            undoManager: {
                ...
                getContent: function (e, t) {
                    return d = c, m = e, g = t, he.from(d.getBody()).fold(J("tree" === m.format ? new Jd("body", 11) : ""), function (e) {
                        return t = d, r = e, o = g, c = ke(ke({}, n = m), {
                            format: o,
                            get: !0,
                            getInner: !0
                ...
                getContent: function (e, t) {
                    return function (e, t, n) {
                        ...
                        if ("text" === i.format) return m = e, he.from(m.selection.getRng()).map(function (e) {
                            var t = he.from(m.dom.getParent(e.commonAncestorContainer, m.dom.isBlock)), n = m.getBody(),
                                r = t.map(function (e) {
                                    return e.nodeName
                                }).getOr("div").toLowerCase(), o = Ct.browser.isIE() && "pre" !== r,
                                i = m.dom.add(n, r, {
                                    "data-mce-bogus": "all",
                                    style: "overflow: hidden; opacity: 0;"
                                }, e.cloneContents()), a = ah(i, o), u = Po(i.textContent);
                            if (m.dom.remove(i), ih(u, 0) || ih(u, u.length - 1)) {
                                var s = ah(t.getOr(n), o), c = s.indexOf(a);
    ...
    function Eh(e, t, n) {
        ...
        !function (e, t) {
            var n = he.from(t.firstChild).map(Et.fromDom), r = he.from(t.lastChild).map(Et.fromDom);
            e.deleteContents(), e.insertNode(t);
            var o = n.bind(Ot).filter(Tn).bind(xh), i = r.bind(Bt).filter(Tn).bind(xh);
    ...
    var kh = St.each, _h = function (e, t, n) {
            kh(e.childNodes, function (e) {
                _p(e) && (t(e) && n(e), e.hasChildNodes() && _h(e, t, n))
            })
        }, Ah = ar([{keep: []}, {rename: ["name"]}, {removed: []}]), Th = /^(src|href|style)$/, Rh = St.each, Dh = hl,
        Oh = St.each, Bh = St.each, Ph = function (S, E, N, r) {
            function k(n, e) {
                var t;
            ...
            function o(w, e, l) {
                var x = [], f = !0, d = A.inline || A.block, m = function (e) {
                    if (K(e)) {
                        var t = u.create(e);
                        return k(t), t
                    }
            ...
            Q(e, function (e, o) {
                function t(e) {
                    var t, n = qp(i, u, o, e.similar, Vp(e) ? e.vars : void 0), r = n.isSome();
                ...
                var t = R(U(e ? Ce(e.getElementsByTagName("img")) : [], function (e) {
                    ...
                    var e = new _r(function (e, t) {
                        ...
                        r = d, i = e, n = t, 0 !== (o = f).src.indexOf("blob:") ? (u = (a = Hh(o.src)).data, s = a.type, c = u, (l = r.getByData(c, s)) ? i({
                            ...
                            n(e)
                        })) : (l = r.getByUri(o.src)) ? i({image: o, blobInfo: l}) : qh(o.src).then(function (t) {
                            var n = t;
                            new _r(function (e) {
    ...
    function Yh(e, p) {
        ...
        p.remove_trailing_brs && e.addNodeFilter("br", function (e, t, n) {
            var r, o, i, a, u, s, c, l, f = e.length, d = St.extend({}, h.getBlockElements()),
        ...
        var e = {
            schema: A, addAttributeFilter: function (e, n) {
                ...
                var m = yv(hv("script,style,head,html,body,title,meta,param"), A.getBlockElements()),
                    ...
                    S = /^[ \t\r\n]+$/, E = Ee(y, u.context) || Ee(y, _.root_name), N = tm({
                        validate: h,
                        document: _.document,
                        ...
                        start: function (e, t, n) {
                            ...
                            if (a) {
                                if (m[e] && !E) {
                                    ...
                                    if ((t = c.lastChild) && 3 === t.type) if (0 < (n = t.value.replace(w, "")).length) t.value = n, t = t.prev; else for (r = t.prev, t.remove(), t = r; t && 3 === t.type;) n = t.value, r = t.prev, 0 !== n.length && !S.test(n) || (t.remove(), t = r), t = r
                                }
                    ...
                    }, A), k = c = new Jd(u.context || _.root_name, 11);
                if (N.parse(e, u.format), h && l.length && (u.context ? u.invalid = !0 : function (e) {
                    for (var t = hv("tr,td,th,tbody,thead,tfoot,table"), n = A.getNonEmptyElements(), r = A.getWhiteSpaceElements(), o = A.getTextBlockElements(), i = A.getSpecialElements(), a = function (e, t) {
                        ...
                        if (c.parent && !c.fixed) if (o[c.name] && "li" === c.parent.name) {
                            ...
                            } else a(c); else c.parent && ("li" !== c.name ? A.isValidChild(c.parent.name, "div") && A.isValidChild("div", c.name) ? c.wrap(B(new Jd("div", 1))) : a(c) : !(d = c.prev) || "ul" !== d.name && "ol" !== d.name ? !(d = c.next) || "ul" !== d.name && "ol" !== d.name ? c.wrap(B(new Jd("ul", 1))) : d.insert(c, d.firstChild, !0) : d.append(c))
                        }
                    }
    ...
    function Qh(L, I) {
        ...
        return (t = U).addAttributeFilter("data-mce-tabindex", function (e, t) {
            ...
            serialize: function (e, t) {
                var n, r, o, i, a, u, s, c, l, f, d, m, g, p, h, v, b, y, C, w, x, S, E, N, k, _, A, T, R,
                    ...
                    }), x = "BODY" !== x.nodeName ? b.body.firstChild : b.body, v = w.doc, w.doc = b), y = p, C = ke(ke({}, h), {node: x}), y.fire("PreProcess", C), v && (w.doc = v), x) : m), o = Po((r = D).getInner ? n.innerHTML : M.getOuterHTML(n)), r.selection || To(Et.fromDom(n)) ? o : St.trim(o)),
    ...
    function iv(e, t, n, r) {
        var o, i, a, u, s, c, l, f, d = nv(n.forced_plugins), m = nv(r.plugins),
            g = rv(o = t, "mobile") ? o.sections().mobile : {}, p = g.plugins ? nv(g.plugins) : m,
    ...
    function av(e, t, n, r, o) {
        var i, a, u, s, c, l, f, d, m = e ? {
                ...
                return ie(c, t)
            }, ee(l = {}), ee(f = {})), {sections: J((d = {t: l, f: f}).t), settings: J(d.f)}),
    ...
    function lv(e, t, n) {
        var r, o, i, a, u, s, c = Et.fromDom(e.getBody()), l = e.inline ? c : Et.fromDom(Tt(c).dom.documentElement),
    ...
    function fv(o) {
        ...
        function t(n, e) {
            if (void 0 === e && (e = !0), !o.removed && (r = (t = o).inline ? t.getBody() : t.getContentAreaContainer(), he.from(r).map(Et.fromDom).map(Fn).getOr(!1))) return e && o.fire("BeforeOpenNotification", {notification: n}), I(c, function (e) {
    ...
    var dv, mv, gv = 0, pv = function (e, t) {
            return e && e.firstChild && e.firstChild === e.lastChild && e.firstChild.name === t
        }, hv = St.makeMap, vv = St.each, bv = St.explode, yv = St.extend, Cv = cu.DOM, wv = (dv = function (e, t) {
            ...
            return n
        }), xv = ft().deviceType, Sv = xv.isTouch(), Ev = xv.isPhone(), Nv = xv.isTablet(),
        kv = ["lists", "autolink", "autosave"], _v = {table_grid: !1, object_resizing: !1, resize: !1}, Av = (mv = {}, {
            add: function (e, t) {
                mv[e] = t
            }, get: function (e) {
                return mv[e] || {icons: {}}
        ...
        }), Tv = A(sv, "clientWidth"), Rv = A(sv, "clientHeight"), Dv = A(cv, "margin-top"), Ov = A(cv, "margin-left"),
        Bv = Cu.PluginManager, Pv = Cu.ThemeManager;
    ...
    function qv() {
        ...
        function i(e) {
            ...
            var t = e.id || Vv("blobid"), n = e.name || t, r = e.blob;
            return {
                id: J(t),
                name: J(n),
    ...
    function Xv(l) {
        ...
        var u, s, c, d, m = qv(), g = Hv(), p = [], h = (d = pu(null), (c = l).on("change AddUndo", function (e) {
            d.set(ke({}, e.level))
        }), {
    ...
    function Jv(n, e) {
        ...
        var s, c = e.block || e.inline || "span",
            l = (s = e.selector) && "string" == typeof s ? (s = (s = s.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1"), St.map(s.split(/(?:>|\s+(?![^\[\]]+\]))/), function (e) {
                var t = St.map(e.split(/(?:~\+|~|\+)/), Gv), n = t.pop();
                return t.length && (n.siblings = t), n
            }).reverse()) : [], f = l.length ? (l[0].name || (l[0].name = c), c = e.selector, Yv(l, n)) : Yv([c], n),
    ...
    function eb(s) {
        var e, n, r, o, i, c = wu(), l = pu(0), f = pu(0), d = {
    ...
    function ob(e, t, n) {
        var r, o, i = (r = e, o = t, U(cu.DOM.getParents(n.container(), "*", o), r));
    ...
    function fb(e) {
        var t, n = M(t = On(e), So).fold(J(t), function (e) {
            return t.slice(0, e)
        });
        return X(n, Mn), n
    }
    ...
    function yb(e, t) {
        var n = Et.fromDom(t), r = A(je, e);
        return hr(n, Ao, r).isSome()
    }

    function Cb(e) {
        var n, r, o, t, i, a, u, s, c, l, f = Et.fromDom(e.getBody()), d = e.selection.getRng();
    ...
    function Eb(e, t, n) {
        var r = fc(1, e.getBody(), t), o = bs.fromRangeStart(r), i = o.getNode();
    ...
    function Tb(e, t) {
        ...
        var r = t ? vc.Forwards : vc.Backwards, o = Wc(e.getBody()), i = A(pc, t ? o.next : o.prev), a = t ? kb : _b,
            u = mc(r, e.getBody(), n), s = ib(t, i(u));
    ...
    function Pb(e) {
        var t, n = e.dom, r = e.selection, o = _f(e.getBody(), r.getNode());
    ...
    var sy, cy, ly = function (t, e) {
        ...
        py = "data-mce-placeholder", hy = /[\u0591-\u07FF\uFB1D-\uFDFF\uFE70-\uFEFC]/, vy = A(ib, !0), by = A(ib, !1),
        yy = Gn, Cy = Jn,
        wy = ar([{remove: ["element"]}, {moveToElement: ["element"]}, {moveToPosition: ["position"]}]), xy = qn,
        Sy = A(zb, !0), Ey = A(zb, !1),
    ...
    var Ly, Iy, My = A(Ty, bs.isAbove, -1), Fy = A(Ty, bs.isBelow, 1), Uy = A(Ry, -1, My), zy = A(Ry, 1, Fy);
    ...
    function jy(o, i, a, e, u, t) {
        ...
        var s = 0, c = [], l = ge(t.getClientRects());
        if (!l) return c;
        var r = t.getNode();
    ...
    function Xy(e, o) {
        return de(e, function (e, t) {
            var n = Math.min(qy(e, o), $y(e, o)), r = Math.min(qy(t, o), $y(t, o));
    ...
    function Gy(e, t, n) {
        var r, o, i, a = Py(U(Ce(e.getElementsByTagName("*")), rc)), u = U(a, A(Ky, n));
    ...
    function Zy(e, t, n, r, o, i) {
        var a = t === vc.Forwards, u = Wc(e.getBody()), s = A(pc, a ? u.next : u.prev), c = a ? r : o;
        if (!n.collapsed) {
            var l = qu(n);
    ...
    function e0(t, e, n, r, o, i) {
        var a = mc(e, t.getBody(), n), u = ge(a.getClientRects()), s = e === Ly.Down;
        if (!u) return he.none();
        var c, l = U((s ? MC : IC)(t.getBody(), Hy(1), a), Vy(1)), f = u.left, d = Xy(l, f);
        if (d && i(d.node)) {
        ...
        if (c = r(a) ? a.getNode() : o(a) ? a.getNode(!0) : qu(n)) {
            var p = function (e, t, n, r) {
                ...
                return c
            }(e, t.getBody(), Hy(1), c), h = Xy(U(p, Vy(1)), f);
    ...
    function m0(g, p) {
        var t, e = Et.fromDom(g.getBody()), n = Et.fromDom(g.selection.getStart()),
            h = U(M(t = xm(n, e), So).fold(J(t), function (e) {
                return t.slice(0, e)
            }), d0);
        return Y(h).exists(function (e) {
            var t, n, r, o, i, a, u, s, c, l = bs.fromRangeStart(g.selection.getRng()), f = p, d = l, m = e.dom;
            return !(!fn(mf(m), gf(m), function (e, t) {
                var n = ib(!0, e), r = ib(!1, t), o = ib(!1, d);
    ...
    function w0(e, s) {
        var c = e.dom, t = e.selection, n = e.formatter, r = e.getParam("indentation", "40px", "string"),
            l = /[a-z%]+$/i.exec(r)[0], f = parseInt(r, 10), d = js(e), o = Ls(e);
        e.queryCommandState("InsertUnorderedList") || e.queryCommandState("InsertOrderedList") || "" !== o || c.getParent(t.getNode(), c.isBlock) || n.apply("div"), X(VC(e), function (e) {
            var t, n = c, r = s, o = f, i = l, a = e.dom, u = b0(d, Et.fromDom(a));
    ...
    function x0(e, t) {
        if (e.selection.isCollapsed() && y0(e)) {
            var n = e.dom, r = e.selection.getRng(), o = bs.fromRangeStart(r),
    ...
    function k0(e) {
        ...
        if (s && Hn(s) && l) {
            ...
            if (a.isValidChild(f, l.toLowerCase()) && (d = u, m = c, g = s, !F(wm(Et.fromDom(g), Et.fromDom(m)), function (e) {
                ...
                for (var d, m, g, p, h, v = i.getRng(), b = v.startContainer, y = v.startOffset, C = v.endContainer, w = v.endOffset, x = Td(e), s = c.firstChild; s;) p = u, qn(h = s) || Hn(h) && !N0(p, h) && !ul(h) ? function (e, t) {
                    if (qn(t)) {
    ...
    function T0(e, t, n) {
        var r, o, i, a = Wc(e.getBody()), u = A(pc, 1 === t ? a.next : a.prev);
    ...
    function I0(h, v) {
        var b = Et.fromDom(h.getBody()), y = bs.fromRangeStart(h.selection.getRng()), C = Ls(h), w = Is(h), e = y,
            t = A(je, b);
    ...
    function z0(t, e) {
        var n = e ? vc.Forwards : vc.Backwards, r = t.selection.getRng();
    ...
    function V0(e, t, n, r, o) {
        var i, a = Au(Et.fromDom(n), "td,th,caption").map(function (e) {
            return e.dom
    ...
    function K0(e, t, n, r) {
        var o, i, a, u, s, c, l, f, d, m, g = e.selection.getRng(), p = bs.fromRangeStart(g), h = e.getBody();
    ...
    function sC(e, t) {
        ...
        n && n.toLowerCase() === t.tagName.toLowerCase() && function (e, o, t) {
            ...
            he.from(t.style).map(i.parseStyle).each(function (e) {
                var t = xn(Et.fromDom(o)), n = ke(ke({}, t), e);
                i.setStyles(o, n)
            ...
            var n = ["style", "class"], r = ne(t, function (e, t) {
                return !ie(n, t)
            });
            i.setAttribs(o, r)
        }(e, t, Is(e))
    ...
    function cC(a, e) {
        ...
        var m = d.startContainer, g = d.startOffset, p = Ls(a), h = !(!e || !e.shiftKey), v = !(!e || !e.ctrlKey);
        ...
        F && ((p && !h || !p && h) && (m = function (e, t, n, r) {
            var o, i, a, u, s, c, l = p || "P", f = e.dom, d = uC(f, n), m = f.getParent(n, f.isBlock);
            if (!m || !iC(f, m)) {
    ...
    function PC(e) {
        var t, n, r = bs.fromRangeStart(e.selection.getRng()), o = Et.fromDom(e.getBody());
        if (e.selection.isCollapsed()) {
            var i = A(rb, e), a = bs.fromRangeStart(e.selection.getRng());
    ...
    function LC(e) {
        ...
        return e.on("keyup compositionstart", A(A0, e)), g = p, (m = e).on("keydown", function (e) {
            ...
            !1 === e.isDefaultPrevented() && (t = m, n = g, r = e, o = ft().os, U0([{
                keyCode: $f.RIGHT,
                action: F0(R0, t, !0)
            }, {keyCode: $f.LEFT, action: F0(R0, t, !1)}, {keyCode: $f.UP, action: F0(D0, t, !1)}, {
                keyCode: $f.DOWN,
                action: F0(D0, t, !0)
            }, {keyCode: $f.RIGHT, action: F0(Y0, t, !0)}, {keyCode: $f.LEFT, action: F0(Y0, t, !1)}, {
                keyCode: $f.UP,
                action: F0(G0, t, !1)
            }, {keyCode: $f.DOWN, action: F0(G0, t, !0)}, {keyCode: $f.RIGHT, action: F0(z0, t, !0)}, {
                keyCode: $f.LEFT,
                action: F0(z0, t, !1)
            }, {keyCode: $f.UP, action: F0(j0, t, !1)}, {keyCode: $f.DOWN, action: F0(j0, t, !0)}, {
                keyCode: $f.RIGHT,
                action: F0(i0, t, n, !0)
                ...
                keyCode: $f.UP,
                action: F0(M0, t, !1)
            }, {keyCode: $f.DOWN, action: F0(M0, t, !0)}], r).each(function (e) {
                r.preventDefault()
            }))
            ...
            !1 === e.isDefaultPrevented() && (n = e, U0([{
                keyCode: $f.BACKSPACE,
                action: F0(Pb, t = f)
            }, {keyCode: $f.DELETE, action: F0(Pb, t)}], n))
            ...
            !1 === e.isDefaultPrevented() && (n = s, r = e, U0([{
                keyCode: $f.END,
                action: F0(O0, t = u, !0)
            }, {keyCode: $f.HOME, action: F0(O0, t, !1)}, {keyCode: $f.END, action: F0(H0, t, !0)}, {
                keyCode: $f.HOME,
                action: F0(H0, t, !1)
    ...
    var IC = A(jy, Ly.Up, ju, Hu), MC = A(jy, Ly.Down, Hu, ju), FC = Jn, UC = ic, zC = function (e, t) {
            var n = e.selection.getRng(), r = e.getBody();
            if (t) {
                var o = bs.fromRangeEnd(n), i = Fy(r, o);
                return Y(i.positions)
            }
            return o = bs.fromRangeStart(n), W((i = My(r, o)).positions)
        }, jC = A(a0, !0), HC = A(a0, !1), VC = function (e) {
            ...
            return e.y > t
        }), KC = A(q0, My), XC = A(q0, Fy), YC = function (e, t) {
            return n = bs.after(t), !!Xn(n.getNode()) || ff(e, bs.after(t)).map(function (e) {
                return Xn(e.getNode())
            }).getOr(!1);
            var n
        }, GC = ar([{br: []}, {block: []}, {none: []}]), JC = ft().browser, QC = ft(), ZC = A(OC, Do), e1 = A(OC, " "),
    ...
    function u1(e) {
        ...
        var r, o, i, s, u, c, a = wu(), l = cu.DOM, f = document, d = a1(u = a, c = e), m = (r = i = a, function () {
            r.on(function (e) {
    ...
    function s1(e) {
        ...
        function t() {
            var t = cu.DOM, n = i.dom, r = document, o = i.inline ? i.getBody() : i.getDoc(), e = ["drop", "dragover"];
            X(e, function (e) {
    ...
    function l1(l) {
        ...
        function c(e, t) {
            ...
            if (e.collapsed) {
                if (!m(e)) {
                    var n = t ? 1 : -1, r = mc(n, v, e), o = r.getNode(!t);
            ...
            if (s === u + 1 && a === e.endContainer) {
                ...
                if (f(c)) return function (e) {
                    ...
                    var r = function (e, t, n) {
                        var r = l.$, o = yr(Et.fromDom(l.getBody()), "#" + b).fold(function () {
                            return r([])
                        }, function (e) {
                            return r([e.dom])
                        });
                    ...
                    }(e, n.targetClone, t), o = Et.fromDom(e);
        ...
        var g, n, e, o, p = l.selection, h = l.dom, u = h.isBlock, v = l.getBody(), s = tc(l, v, u, function () {
            return Td(l)
        }), b = "sel-" + h.uniqueId(), y = "data-mce-selected", r = p.getRng, C = function () {
            s.hide()
        };
        return Ct.ceFalse && !bh(l) && (l.on("mouseup", function (e) {
            ...
            showCaret: d, showBlockCaretContainer: function (e) {
                e.hasAttribute("data-mce-caret") && (Qr(e), i(r()), p.scrollIntoView(e))
            }, hideFakeCaret: C, destroy: function () {
                s.destroy(), g = null
            }
        };

        function w(e, t) {
            var n, r = h.getParent(e, u), o = h.getParent(t, u);
    ...
    function f1(a) {
        ...
        var p = St.each, h = $f.BACKSPACE, v = $f.DELETE, b = a.dom, y = a.selection, C = a.parser, w = Ct.gecko,
            x = Ct.ie, S = Ct.webkit, E = "data:text/mce-internal,", N = x ? "Text" : "URL", k = oe;
    ...
    function g1(e) {
        ...
        e.bindPendingEventDelegates(), e.initialized = !0, e.fire("Init"), e.focus(!0), n = (u = e).dom.getRoot(), u.inline || Vl(u) && u.selection.getStart(!0) !== n || mf(n).each(function (e) {
            var t, n, r, o, i = e.getNode(), a = sn(i) ? mf(i).getOr(e) : e;
    ...
    function h1(e) {
        ...
        var r, o = p1(e), i = Hs(e), a = e.contentCSS;
    ...
    function v1(e) {
        ...
        !0 !== e.removed && (bh(t = e) || t.load({
            initial: !0,
            format: "html"
        }), t.startContent = t.getContent({format: "raw"}), g1(e))
    }
    ...
    function b1(t, e) {
        ...
        }), i), t.serializer = Zh((a = t.settings, ke(ke({}, m1(t)), d1({
    ...
    function S1(e) {
        var n, t, r, o, i, a, u, s;
        e.fire("ScriptsLoaded"), n = e, t = St.trim(Fs(n)), r = n.ui.registry.getAll().icons, Q(ke(ke({}, Av.get("default").icons), Av.get(t).icons), function (e, t) {
        ...
        var c = x1(e), l = e, f = he.from(c.api).getOr({}), d = {
    ...
    function k1(c, l) {
        var e, t, f = mu.ScriptLoader, n = f, r = l, o = function () {
    ...
    var D1 = Jn, O1 = Gn, B1 = function (e) {
            e.on(function (e) {
                i1(e.ghost)
            }), e.clear()
        }, P1 = Gn, L1 = Jn, I1 = cu.DOM, M1 = cu.DOM, F1 = cu.DOM, U1 = function (t, n, r) {
            var o, i, a, u, e = Bv.get(r), s = Bv.urls[r] || t.documentBaseUrl.replace(/\/$/, "");
        ...
        }, z1 = cu.DOM, j1 = {"font-size": "size", "font-family": "face"}, H1 = _1("font-size"), V1 = i(function (e) {
            return e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")
        }, _1("font-family")), q1 = St.each, $1 = St.map, W1 = St.inArray,
        K1 = (X1.prototype.execCommand = function (t, n, r, e) {
            ...
            this.addCommands({
                "mceResetDesignMode,mceBeginUndoLevel": oe, "mceEndUndoLevel,mceAddUndoLevel": function () {
                    u.undoManager.add()
                    ...
                    w0(u, e)
                }, mceRepaint: oe, InsertHorizontalRule: function () {
                ...
                return T1(t = u, function (n) {
                    ...
                    return Pg(n, function (e) {
                        ...
                        var e = parseFloat(Cn(n, "line-height")), t = parseFloat(Cn(n, "font-size"));
                        return String(e / t)
                    })
                }).getOr("");
                var t
    ...
    var tw = "data-mce-contenteditable",
        ...
        rw = (ow.isNative = function (e) {
            ...
            var n = e.toLowerCase(), r = bo(n, t || {}, this.scope);
    ...
    var fw, dw = {
    ...
    }), pw = ["design", "readonly"], hw = St.each, vw = St.explode, bw = {
        f1: 112,
        f2: 113,
        f3: 114,
        f4: 115,
        ...
        f11: 122,
        f12: 123
    }, yw = St.makeMap("alt,ctrl,shift,meta,access"), Cw = (ww.prototype.add = function (e, n, t, r) {
        ...
        return o[o.length - 1] = St.extend(o[o.length - 1], {
            func: n,
            scope: r || this.editor
        }), St.extend(o[0], {desc: this.editor.translate(t), subpatterns: o.slice(1)})
    ...
    var Aw = cu.DOM, Tw = St.extend, Rw = St.each, Dw = St.resolve, Ow = Ct.ie,
        Bw = (Pw.prototype.render = function () {
            ...
            if (t) {
                (e = e || {}).load = !0;
                var n = Vn(t) ? t.value : t.innerHTML, r = this.setContent(n, e);
    ...
    function Pw(e, t, n) {
        ...
        this.plugins = {}, this.contentCSS = [], this.contentStyles = [], this.loadedCSS = {}, this.isNotDirty = !1, this.editorManager = n, this.documentBaseUrl = n.documentBaseURL, Tw(this, gw), this.settings = (d = (f = this).documentBaseUrl, m = n.defaultSettings, p = d, h = Sv, v = f, b = {
            ...
            registry: {
                ...
                getAll: r.getAll
            }, styleSheetLoader: void 0, show: oe, hide: oe, enable: oe, disable: oe, isDisabled: T
        };
        var x, S, E, N, k, _ = (N = pu("design"), k = pu({
        ...
        this.mode = _, this.setMode = _.set, n.fire("SetupEditor", {editor: this}), this.execCallback("setup", this), this.$ = ou.overrideDefaults(function () {
    ...
    var Fw, Uw = cu.DOM, zw = St.explode, jw = St.each, Hw = St.extend, Vw = 0, qw = !1, $w = [], Ww = [],
        Kw = "CSS1Compat" !== document.compatMode, Xw = ke(ke({}, dw), {
            baseURI: null,
            baseURL: null,
            defaultSettings: {},
            ...
            settings: {},
            setup: function () {
                var e, t = "", n = kw.getDocumentBaseUrl(document.location);
            ...
            add: function (e) {
                var n = this;
                return $w[e.id] === e || (null === n.get(e.id) && ("length" !== e.id && ($w[e.id] = e), $w.push(e), Ww.push(e)), Iw(!0), n.activeEditor = e, n.fire("AddEditor", {editor: e}), Fw || (Fw = function (e) {
    ...
    var Qw, Zw, ex, tx, nx = Math.min, rx = Math.max, ox = Math.round, ix = {
        inflate: function (e, t, n) {
            return Jw(e.x - t, e.y - n, e.w + 2 * t, e.h + 2 * n)
        }, relativePosition: Yw, findBestRelativePosition: function (e, t, n, r) {
            for (var o, i = 0; i < r.length; i++) if ((o = Yw(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y) return r[i];
            return null
        }, intersect: function (e, t) {
            var n = rx(e.x, t.x), r = rx(e.y, t.y), o = nx(e.x + e.w, t.x + t.w), i = nx(e.y + e.h, t.y + t.h);
            return o - n < 0 || i - r < 0 ? null : Jw(n, r, o - n, i - r)
        }, clamp: function (e, t, n) {
            var r = e.x, o = e.y, i = e.x + e.w, a = e.y + e.h, u = t.x + t.w, s = t.y + t.h, c = rx(0, t.x - r),
                l = rx(0, t.y - o), f = rx(0, i - u), d = rx(0, a - s);
            return r += c, o += l, n && (i += c, a += l, r -= f, o -= d), Jw(r, o, (i -= f) - r, (a -= d) - o)
        }, create: Jw, fromClientRect: function (e) {
    ...
    var cx, lx, fx, dx = Math.min, mx = Math.max, gx = Math.round, px = {
        serialize: function (e) {
        ...
        callbacks: {}, count: 0, send: function (t) {
            var n = this, r = cu.DOM, o = (void 0 !== t.count ? t : n).count, i = "tinymce_jsonp_" + o;
        ...
        send: function (e) {
            ...
            if (e.scope = e.scope || this, e.success_scope = e.success_scope || e.scope, e.error_scope = e.error_scope || e.scope, e.async = !1 !== e.async, e.data = e.data || "", vx.fire("beforeInitialize", {settings: e}), (t = new XMLHttpRequest).overrideMimeType && t.overrideMimeType(e.content_type), t.open(e.type || (e.data ? "POST" : "GET"), e.url, e.async), e.crossDomain && (t.withCredentials = !0), e.content_type && t.setRequestHeader("Content-Type", e.content_type), e.requestheaders && St.each(e.requestheaders, function (e) {
    ...
    }), bx = St.extend, yx = (Cx.sendRPC = function (e) {
        return (new Cx).send(e)
    }, Cx.prototype.send = function (e) {
        var n = e.error, r = e.success, o = bx(this.settings, e);
...
$(function () {
    let editor_config = {
        ...
        init_instance_callback : function(editor) {
            let freeTiny = document.querySelector('.mce-notification');
