!function (e, t) {
    ...
    const S = () => f(".".concat(h.loader)), T = () => f(".".concat(h.actions, " .").concat(h.cancel)),
        L = () => y(h.actions), O = () => y(h.footer), j = () => y(h["timer-progress-bar"]), D = () => y(h.close),
        I = () => {
    ...
    const q = {previousBodyPadding: null}, V = (t, e) => {
        ...
        Q = () => !G(P()) && !G(E()) && !G(T()), ee = e => !!(e.scrollHeight > e.clientHeight), te = e => {
        ...
        ae = () => {
            ...
            const n = L();
            var o = S(), i = P(), a = E(), s = T();
            (t.showConfirmButton || t.showDenyButton || t.showCancelButton ? Z : J)(n), U(n, t, "actions"), pe(i, "confirm", t), pe(a, "deny", t), pe(s, "cancel", t), function (e, t, n, o) {
    ...
    const $e = () => {
        ...
        nt = e => e.touches && 1 < e.touches.length, ot = () => {
    ...
    function at(e, t, n, o) {
        H() ? ct(e, o) : (He(n).then(() => ct(e, o)), Me.keydownTarget.removeEventListener("keydown", Me.keydownHandler, {capture: Me.keydownListenerCapture}), Me.keydownHandlerAdded = !1), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (t.setAttribute("style", "display:none !important"), t.removeAttribute("class"), t.innerHTML = "") : t.remove(), M() && (null !== q.previousBodyPadding && (document.body.style.paddingRight = "".concat(q.previousBodyPadding, "px"), q.previousBodyPadding = null), N(document.body, h.iosfix) && (t = parseInt(document.body.style.top, 10), _(document.body, h.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * t), ot()), _([document.documentElement, document.body], [h.shown, h["height-auto"], h["no-backdrop"], h["toast-shown"]])
    }
        ...
        if (t) {
            ...
            if (n && !N(t, n.hideClass.popup)) {
                ...
                _(o, n.showClass.backdrop), W(o, n.hideClass.backdrop), ((e, t, n) => {
                    ...
                    if (i) rt(e, t, o, n.returnFocus, n.didClose); else at(e, o, n.returnFocus, n.didClose)
                })(this, t, n), i(e)
            }
        }
    }
    ...
    const ht = ["swal-title", "swal-html", "swal-footer"], gt = e => {
        ...
        Ot = e => e.files.length ? null !== e.getAttribute("multiple") ? e.files : e.files[0] : null, jt = (t, n) => {
            const o = v(), i = e => It[n.input](o, Mt(e), n);
        ...
        }, Ht = (e, t) => t && t.toString() === e.toString(), qt = (e, t) => {
            var n = he.innerParams.get(e), o = ((e, t) => {
                const n = e.getInput();
                if (!n) return null;
                switch (t.input) {
                    case"checkbox":
    ...
    e = Object.freeze({
        hideLoading: Xe, disableLoading: Xe, getInput: function (e) {
            ...
            Ze(Object.assign({}, t, e)), Me.currentInstance && (Me.currentInstance._destroy(), M() && ot()), Me.currentInstance = this, mt(e = ((e, t) => {
                const n = gt(e), o = Object.assign({}, Re, t, n, e);
    ...
    }), cn.DismissReason = l, cn.version = "11.1.3";
    const ln = cn;
