...
!function (a) {
    ...
    a.extend(a.expr.pseudos || a.expr[":"], {
        ...
        messages: {
            ...
            maxlength: a.validator.format("Vui lòng nhập không quá {0} ký tự."),
            minlength: a.validator.format("Vui lòng nhập ít nhất {0} ký tự."),
            rangelength: a.validator.format("Vui lòng nhập một giá trị có độ dài từ {0} đến {1} ký tự."),
            range: a.validator.format("Vui lòng nhập giá trị từ {0} đến {1}."),
            max: a.validator.format("Vui lòng nhập giá trị nhỏ hơn hoặc bằng {0}."),
            min: a.validator.format("Vui lòng nhập giá trị lớn hơn hoặc bằng {0}."),
            step: a.validator.format("Vui lòng nhập bội số của {0}.")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function () {
