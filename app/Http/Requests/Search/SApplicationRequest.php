...
class SApplicationRequest extends FormRequest
{
    ...
    {
        return [
            'filter1' => 'nullable|string|min:2|max:10',
    ...
    public function messages(): array
    {
        return [
            ...
            'filter1.max' => ':attribute tối đa 10 ký tự.',
    ...
    {
        return [
            'filter1' => 'Tên ứng dụng',
            'filter2' => 'Thể loại ứng dụng',
            'filter3' => 'Trạng thái',
            'start_date' => 'Ngày bắt đầu',
            'end_date' => 'Ngày kết thúc',
            'datatableSearch' => 'Team, ID in app'
        ];
    }
