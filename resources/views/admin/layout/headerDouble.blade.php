  ...
  <div class="card-body card-body-height">
    ...
    <div class="nav nav-pills flex-column">
      <a class="nav-link" href="#">
        <div class="media align-items-center">
          <span class="mr-3">
            <img class="avatar avatar-xs" src="{{asset('/assets/svg/brands/atlassian.svg')}}" alt="Image Description">
          </span>
          <div class="media-body text-truncate">
      ...
      <a class="nav-link" href="#">
        <div class="media align-items-center">
          <span class="mr-3">
            <img class="avatar avatar-xs" src="{{asset('/assets/svg/brands/slack.svg')}}" alt="Image Description">
          </span>
          <div class="media-body text-truncate">
      ...
      <a class="nav-link" href="#">
        <div class="media align-items-center">
          <span class="mr-3">
            <img class="avatar avatar-xs" src="{{asset('/assets/svg/brands/frontapp.svg')}}" alt="Image Description">
          </span>
          <div class="media-body text-truncate">
      ...
      <a class="nav-link" href="#">
        <div class="media align-items-center">
          <span class="mr-3">
            <img class="avatar avatar-xs" src="{{asset('/assets/svg/illustrations/review-rating-shield.svg')}}" alt="Image Description">
          </span>
          <div class="media-body text-truncate">
...
<li class="nav-item">
  ...
  <div class="hs-unfold">
   ...
   <div class="avatar avatar-sm avatar-circle">
    <img class="avatar-img" src="{{asset('/assets/images/160x160/img6.jpg')}}" alt="Image Description">
