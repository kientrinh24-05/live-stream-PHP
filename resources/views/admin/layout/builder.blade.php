...
<div id="styleSwitcherDropdown" class="hs-unfold-content sidebar sidebar-bordered sidebar-box-shadow" style="width: 35rem;">
  <div class="card card-lg border-0 h-100">
    <div class="card-header align-items-start">
      <div class="mr-2">
        <h3 class="card-header-title">Tùy chỉnh giao diện</h3>
        <p>Chọn giao diện theo sở thích của bạn</p>
      </div>
  ...
  <div class="card-body sidebar-scrollbar">
    ...
    <p>3 loại bố cục giao diện để lựa chọn.</p>
        ...
        <div class="text-center">
          <div class="custom-checkbox-card mb-2">
            ...
            <label class="custom-checkbox-card-label" for="layoutSkinsRadio1">
              <img class="custom-checkbox-card-img" src="{{asset('/assets/svg/layouts/layouts-sidebar-default.svg')}}" alt="Image Description">
            </label>
        ...
        <div class="text-center">
          <div class="custom-checkbox-card mb-2">
            ...
            <label class="custom-checkbox-card-label" for="layoutSkinsRadio2">
              <img class="custom-checkbox-card-img" src="{{asset('/assets/svg/layouts/layouts-sidebar-dark.svg')}}" alt="Image Description">
            </label>
        ...
        <div class="text-center">
          <div class="custom-checkbox-card mb-2">
            ...
            <label class="custom-checkbox-card-label" for="layoutSkinsRadio3">
              <img class="custom-checkbox-card-img" src="{{asset('/assets/svg/layouts/layouts-sidebar-light.svg')}}" alt="Image Description">
            </label>
        ...
        <div class="text-center">
          <div class="custom-checkbox-card mb-2">
            ...
            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions1">
              <img class="custom-checkbox-card-img" src="{{asset('/assets/svg/layouts/sidebar-default-classic.svg')}}" alt="Image Description">
            </label>
            <span class="custom-checkbox-card-text">Default</span>
          </div>
        </div>
        ...
        <div class="text-center">
          <div class="custom-checkbox-card mb-2">
            ...
            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions2">
              <img class="custom-checkbox-card-img" src="{{asset('/assets/svg/layouts/sidebar-compact.svg')}}" alt="Image Description">
            </label>
        ...
        <div class="text-center">
          <div class="custom-checkbox-card mb-2">
            ...
            <label class="custom-checkbox-card-label" for="sidebarLayoutOptions3">
              <img class="custom-checkbox-card-img" src="{{asset('/assets/svg/layouts/sidebar-mini.svg')}}" alt="Image Description">
            </label>
        ...
        <div class="text-center">
          <div class="custom-checkbox-card mb-2">
            ...
            <label class="custom-checkbox-card-label" for="headerLayoutOptions1">
              <img class="custom-checkbox-card-img" src="{{asset('/assets/svg/layouts/header-default-fluid.svg')}}" alt="Image Description">
            </label>
        ...
        <div class="text-center">
          <div class="custom-checkbox-card mb-2">
            ...
            <label class="custom-checkbox-card-label" for="headerLayoutOptions2">
              <img class="custom-checkbox-card-img" src="{{asset('/assets/svg/layouts/header-default-container.svg')}}" alt="Image Description">
            </label>
        ...
        <div class="text-center">
          <div class="custom-checkbox-card mb-2">
            ...
            <label class="custom-checkbox-card-label" for="headerLayoutOptions3">
              <img class="custom-checkbox-card-img" src="{{asset('/assets/svg/layouts/header-double-line-fluid.svg')}}" alt="Image Description">
            </label>
        ...
        <div class="text-center">
          <div class="custom-checkbox-card mb-2">
            ...
            <label class="custom-checkbox-card-label" for="headerLayoutOptions4">
              <img class="custom-checkbox-card-img" src="{{asset('/assets/svg/layouts/header-double-line-container.svg')}}" alt="Image Description">
            </label>
