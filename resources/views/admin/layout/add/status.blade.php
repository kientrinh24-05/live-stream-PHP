    ...
    <div class="input-group input-group-sm-down-break">
        ...
        <div class="form-control">
            <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" name="status" id="actived" value="1" checked="">
        ...
        <div class="form-control">
            <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" name="status" id="notactived" value="0">
