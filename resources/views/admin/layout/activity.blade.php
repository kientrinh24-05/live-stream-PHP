        ...
        <div class="card-body sidebar-body sidebar-scrollbar">
            ...
            <ul class="step step-icon-sm step-avatar-sm">
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        <div class="step-avatar">
                            <img class="step-avatar-img" src="{{asset('/assets/images/160x160/img9.jpg')}}"
                      ...
                      <span class="mt-1 mr-2">
                        <img class="avatar avatar-xs" src="{{asset('/assets/svg/brands/excel.svg')}}"
                             alt="Image Description">
                      </span>
                                        ...
                                        <div class="col-6">
                                            <div class="media">
                      <span class="mt-1 mr-2">
                        <img class="avatar avatar-xs" src="{{asset('/assets/svg/brands/word.svg')}}"
                             alt="Image Description">
                      </span>
                                                <div class="media-body text-truncate">
                                                    <span class="d-block font-size-sm text-dark text-truncate"
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        <div class="step-avatar">
                            <img class="step-avatar-img" src="{{asset('/assets/images/160x160/img3.jpg')}}"
                                 alt="Image Description">
                        </div>
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        <div class="step-avatar">
                            <img class="step-avatar-img" src="{{asset('/assets/images/160x160/img7.jpg')}}"
                                 alt="Image Description">
                        </div>
                ...
                <li class="step-item">
                    <div class="step-content-wrapper">
                        <div class="step-avatar">
                            <img class="step-avatar-img" src="{{asset('/assets/images/160x160/img5.jpg')}}"
                                 alt="Image Description">
                        </div>
