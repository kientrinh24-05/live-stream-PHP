        ...
        <div class="d-none d-md-block">
          ...
          <div id="searchDropdownMenu" class="hs-form-search-menu-content card dropdown-menu dropdown-card overflow-hidden">
            ...
            <div class="card-body-height py-3">
              ...
              <a class="dropdown-item my-2" href="index.html">
                <div class="media align-items-center">
                  <img class="avatar avatar-xs avatar-circle mr-2" src="{{asset('/assets/images/160x160/img10.jpg')}}" alt="Image Description">
                  <div class="media-body text-truncate">
              ...
              <a class="dropdown-item my-2" href="index.html">
                <div class="media align-items-center">
                  <img class="avatar avatar-xs avatar-circle mr-2" src="{{asset('/assets/images/160x160/img3.jpg')}}" alt="Image Description">
                  <div class="media-body text-truncate">
            ...
            <div class="row">
              <div class="col-auto position-static">
                <div class="d-flex align-items-center">
                  ...
                  <div class="avatar avatar-sm avatar-circle">
                    <img class="avatar-img" src="{{asset('/assets/images/160x160/img7.jpg')}}" alt="Image Description">
                  </div>
                </div>
              </div>
              <div class="col ml-n3">
            ...
            <div class="row">
              <div class="col-auto position-static">
                <div class="d-flex align-items-center">
                  ...
                  <div class="avatar avatar-sm avatar-circle">
                    <img class="avatar-img" src="{{asset('/assets/images/160x160/img5.jpg')}}" alt="Image Description">
                  </div>
                </div>
              </div>
              <div class="col ml-n3">
            ...
            <div class="row">
              <div class="col-auto position-static">
                <div class="d-flex align-items-center">
                  ...
                  <div class="avatar avatar-sm avatar-circle">
                    <img class="avatar-img" src="{{asset('/assets/images/160x160/img8.jpg')}}" alt="Image Description">
                  </div>
                </div>
              </div>
              <div class="col ml-n3">
  ...
  <div class="card-body card-body-height">
    ...
    <div class="nav nav-pills flex-column">
      <a class="nav-link" href="#">
        <div class="media align-items-center">
          <span class="mr-3">
            <img class="avatar avatar-xs avatar-4by3" src="{{asset('/assets/svg/brands/atlassian.svg')}}" alt="Image Description">
          </span>
          <div class="media-body text-truncate">
      ...
      <a class="nav-link" href="#">
        <div class="media align-items-center">
          <span class="mr-3">
            <img class="avatar avatar-xs avatar-4by3" src="{{asset('/assets/svg/brands/slack.svg')}}" alt="Image Description">
          </span>
          <div class="media-body text-truncate">
      ...
      <a class="nav-link" href="#">
        <div class="media align-items-center">
          <span class="mr-3">
            <img class="avatar avatar-xs avatar-4by3" src="{{asset('/assets/svg/brands/google-webdev.svg')}}" alt="Image Description">
          </span>
          <div class="media-body text-truncate">
      ...
      <a class="nav-link" href="#">
        <div class="media align-items-center">
          <span class="mr-3">
            <img class="avatar avatar-xs avatar-4by3" src="{{asset('/assets/svg/brands/frontapp.svg')}}" alt="Image Description">
          </span>
          <div class="media-body text-truncate">
      ...
      <a class="nav-link" href="#">
        <div class="media align-items-center">
          <span class="mr-3">
            <img class="avatar avatar-xs avatar-4by3" src="{{asset('/assets/svg/illustrations/review-rating-shield.svg')}}" alt="Image Description">
          </span>
          <div class="media-body text-truncate">
