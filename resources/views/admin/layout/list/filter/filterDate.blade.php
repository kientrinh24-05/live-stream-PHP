<div class="form-row">
    <div class="col-sm form-group">
        ...
        <div
            ...
            id="dateStart" data-hs-flatpickr-options='{"appendTo": "#dateStart", "dateFormat": "Y-m-d","wrap": true}'>
    ...
    <div class="col-sm form-group">
        ...
        <div
            class="js-flatpickr flatpickr-custom input-group input-group-merge"
            id="dateEnd" data-hs-flatpickr-options='{"appendTo": "#dateEnd", "dateFormat": "Y-m-d","wrap": true}'>
            <div class="input-group-prepend" data-toggle="">
                <div class="input-group-text">
                    <i class="tio-calendar-month"></i>
                </div>
