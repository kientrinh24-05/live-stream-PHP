                            ...
                            <ul class="list-group list-group-flush list-group-no-gutters">
                                    ...
                                    <div class="media">
                                        <div class="mt-1 mr-3">
                                            <img class="avatar avatar-xs avatar-4by3"
                                                 src="{{asset('/assets/svg/brands/capsule.svg')}}"
                                ...
                                <li class="list-group-item py-3">
                                    <div class="media">
                                        <div class="mt-1 mr-3">
                                            <img class="avatar avatar-xs avatar-4by3"
                                                 src="{{asset('/assets/svg/brands/mailchimp.svg')}}"
                                                 alt="Image Description">
                                        </div>
                                        <div class="media-body">
                                            <div class="row align-items-center">
                            ...
                            <div class="row align-items-sm-center">
                                <div class="col-sm-auto">
                                    <div class="d-flex align-items-center mr-2">
                                        ...
                                        <select class="js-select2-custom js-datatable-filter custom-select-sm" size="1"
                                                style="opacity: 0;" data-target-column-index="2"
                                ...
                                <div class="col-sm-auto">
                                    <div class="d-flex align-items-center mr-2">
                                        ...
                                        {{-- Select --}}
                                        <select class="js-select2-custom js-datatable-filter custom-select-sm" size="1"
                                                style="opacity: 0;" data-target-column-index="5"
                                                data-hs-select2-options='{
                                                  "minimumResultsForSearch": "Infinity",
                                                  "customClass": "custom-select custom-select-sm custom-select-borderless",
                                                  "dropdownAutoWidth": true,
 ...
 "pagination": "datatablePagination"
                            ...
                            <td class="table-column-pl-0">
                                <a class="media align-items-center" href="user-profile.html">
                                    <div class="avatar avatar-sm avatar-circle mr-2">
                                        <img class="avatar-img" src="{{asset('/assets/images/160x160/img10.jpg')}}"
                                             alt="Image Description">
                                    </div>
                                    <div class="media-body">
                        ...
                        <tr>
                            ...
                            <td class="table-column-pl-0">
                                <a class="media align-items-center" href="user-profile.html">
                                    <div class="avatar avatar-sm avatar-circle mr-2">
                                        <img class="avatar-img" src="{{asset('/assets/images/160x160/img3.jpg')}}"
                                             alt="Image Description">
                                    </div>
                                    <div class="media-body">
                        ...
                        <tr>
                            ...
                            <td class="table-column-pl-0">
                                <a class="media align-items-center" href="user-profile.html">
                                    <div class="avatar avatar-sm avatar-circle mr-2">
                                        <img class="avatar-img" src="{{asset('/assets/images/160x160/img5.jpg')}}"
                                             alt="Image Description">
                                    </div>
                                    <div class="media-body">
                        ...
                        <tr>
                            ...
                            <td class="table-column-pl-0">
                                <a class="media align-items-center" href="user-profile.html">
                                    <div class="avatar avatar-sm avatar-circle mr-2">
                                        <img class="avatar-img" src="{{asset('/assets/images/160x160/img9.jpg')}}"
                                             alt="Image Description">
                                    </div>
                                    <div class="media-body">
                        ...
                        <tr>
                            ...
                            <td class="table-column-pl-0">
                                <a class="media align-items-center" href="user-profile.html">
                                    <div class="avatar avatar-sm avatar-circle mr-2">
                                        <img class="avatar-img" src="{{asset('/assets/images/160x160/img4.jpg')}}"
                                             alt="Image Description">
                                    </div>
                                    <div class="media-body">
                        ...
                        <tr>
                            ...
                            <td class="table-column-pl-0">
                                <a class="media align-items-center" href="user-profile.html">
                                    <div class="avatar avatar-sm avatar-circle mr-2">
                                        <img class="avatar-img" src="{{asset('/assets/images/160x160/img6.jpg')}}"
                                             alt="Image Description">
                                    </div>
                                    <div class="media-body">
                        ...
                        <tr>
                            ...
                            <td class="table-column-pl-0">
                                <a class="media align-items-center" href="user-profile.html">
                                    <div class="avatar avatar-sm avatar-circle mr-2">
                                        <img class="avatar-img" src="{{asset('/assets/images/160x160/img8.jpg')}}"
                                             alt="Image Description">
                                    </div>
                                    <div class="media-body">
                        ...
                        <tr>
                            ...
                            <td class="table-column-pl-0">
                                <a class="media align-items-center" href="user-profile.html">
                                    <div class="avatar avatar-sm avatar-circle mr-2">
                                        <img class="avatar-img" src="{{asset('/assets/images/160x160/img7.jpg')}}"
                                             alt="Image Description">
                                    </div>
                                    <div class="media-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="progress rounded-pill mb-2">
                                ...
                                <div class="progress-bar opacity" role="progressbar" style="width: 33%"
                                     aria-valuenow="33" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"
                                     data-placement="top" title="Net volume from sales"></div>
                                <div class="progress-bar opacity-xs" role="progressbar" style="width: 9%"
                                     aria-valuenow="9" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip"
                                     data-placement="top" title="New volume from sales"></div>
                            </div>
