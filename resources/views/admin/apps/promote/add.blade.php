    ...
    <main id="content" role="main" class="main">
        <div class="content container-fluid">
            ...
            @include('admin.layout.add.headerPage', [
                     ...
                     'page' => 'Add',
                     'pagetitle' => 'Thêm đề xuất ứng dụng mới',
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card mb-3 mb-lg-5">
                            {{-- Header --}}
                            @include('admin.layout.add.headerForm', ['headertitle' => "Chi tiết đề xuất"])
                            {{-- End Header --}}
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group required">
                                    ...
                                    <input type="text" class="form-control" name="title" id="title"
                                           value="{{ old('title') }}" placeholder="Tiêu đề đề xuất ứng dụng" required>
                                </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group required">
                                            ...
                                            <textarea name="register" id="register" class="form-control tinymce"
                                                      rows="10" required>{{ old('register') }}</textarea>
                                        </div>
                                    </div>
                                    {{-- End Form Group Content --}}
                                </div>
