    ...
    <main id="content" role="main" class="main">
        <div class="content container-fluid">
            ...
            @include('admin.layout.add.headerPage', [
                     ...
                     'breadcrumb' => 'Policy',
                     'page' => 'Add',
                     'pagetitle' => 'Thêm chính sách lương mới',
                     'linklist' => 'app/policy/list',
                     'list' => 'List Policy'
                 ])
            {{-- End Page Header --}}
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card mb-3 mb-lg-5">
                            {{-- Header --}}
                            @include('admin.layout.add.headerForm', ['headertitle' => "Chi tiết chính sách"])
                            {{-- End Header --}}
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group required">
                                            <label for="policy_idol" class="input-label">Chính sách lương Idol </label>
