            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <h1 class="page-header-title">Chính sách lương Agency: {{ $policyAgency->policyApp->name }}</h1>
                    </div>
                    ...
                    <div class="alert alert-soft-dark mb-5 mb-lg-7" role="alert">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                ...
                                <p class="mb-0">Đọc kỹ chính sách lương Agency {{ $policyAgency->policyApp->name }}. Chính sách
                                    lương Agency là bảo mật, vui lòng không tiết lộ và truyền tải ra bên ngoài.</p>
                            </div>
                        </div>
                    </div>
                    {{-- End Alert --}}

                    {!! $policyAgency->policy_agency !!}
                </div>
