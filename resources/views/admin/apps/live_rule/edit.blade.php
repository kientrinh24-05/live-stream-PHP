    ...
    <main id="content" role="main" class="main">
        <div class="content container-fluid">
            ...
            @include('admin.layout.add.headerPage', [
                         ...
                         'page' => 'Edit',
                         'pagetitle' => "Chỉnh sửa quy định live: {$rule->ruleApp->name}",
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card mb-3 mb-lg-5">
                            {{-- Header --}}
                            @include('admin.layout.add.headerForm', ['headertitle' => "Chi tiết quy định: {$rule->ruleApp->name}"])
                            {{-- End Header --}}
                            ...
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <div class="form-group required">
                                            ...
                                            <select class="js-select2-custom custom-select" id="cate" size="1"
                                                ...
                                                @foreach($menus as $cate)
                                                    <option
                                                        value="{{ $cate->id }}" {{ $rule->cate_id == $cate->id ? 'selected' : ''}}>{{ $cate->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group required">
                                            ...
                                            <select class="js-select2-custom custom-select" id="app_id" size="1"
                                                ...
                                                <option value="{{$rule->app_id}}" selected> {{$rule->ruleApp->name}}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group required">
                                            <label for="active_day" class="input-label">Quy định live có hiệu lực từ
                                                ngày</label>
                                            <div class="js-flatpickr flatpickr-custom input-group input-group-merge"
                                                ...
                                                <input type="text" id="active_day" name="active_day" data-input=""
                                                       ...
                                                       placeholder="Ngày hiệu lực của quy định"
                                                       value="{{ $rule->active_day }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {{-- Form Group Status --}}
                                    <div class="col-sm-3">
                                        @include('admin.layout.edit.status', ['value' => 'rule'])
