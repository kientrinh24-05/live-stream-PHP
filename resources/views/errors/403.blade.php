        ...
        <div class="footer-height-offset d-flex justify-content-center align-items-center flex-column">
            <div class="row align-items-sm-center w-100">
                ...
                <div class="col-sm-6 col-md-4 text-center text-sm-left">
                    ...
                    <p class="lead">Bạn không có quyền thực hiện hành động này. Vui lòng liên hệ admin để biết thêm thông tin chi tiết.</p>
                    <a class="btn btn-primary" href="{{url()->previous()}}">Quay lại trang trước</a>
                </div>
            </div>
            {{-- End Row --}}
        </div>
