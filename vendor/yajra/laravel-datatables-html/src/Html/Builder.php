...
class Builder
{
    ...
    public function __construct(Repository $config, Factory $view, HtmlBuilder $html)
    {
        ...
        $this->attributes = [
            ...
            'language' => [
                ...
                'processing' => '<div class="text-center p-4"><img class="mb-3" src="/assets/images/load.gif" alt="Loading" ></div>'
            ],
            'select' => [
                'style' => 'multi',
    ...
    public function table(array $attributes = [], $drawFooter = false, $drawSearch = false)
    {
        ...
        $tableHtml .= '<thead class="thead-light"><tr>'. implode('', $th) . '</tr>' . $searchHtml . '</thead>';
        if ($drawFooter) {
